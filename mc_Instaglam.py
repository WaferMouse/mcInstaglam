...
worldname = str(sys.argv[6]) # For the following lines, replace the text between quotes with what is described by the comment
...
jmc2objdir = os.path.expanduser('~/jmc2obj/') # Directory for jmc2obj .jar
