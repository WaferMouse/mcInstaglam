...
csvfile = open('blendit-'+worldname+'.log', 'r', newline='')
...
for obj in bpy.data.objects:
    ...
    if ( obj.type =='CAMERA') and ( cameraNames == '' or obj.name.find(cameraNames) != -1) :
        ...
        bpy.data.scenes[sceneKey].render.filepath = worldname+'-'+str(cam[4])
